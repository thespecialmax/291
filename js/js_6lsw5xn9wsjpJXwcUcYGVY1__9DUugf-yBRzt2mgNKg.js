Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n!=1)); }, 'strings': {"":{"Search":"R\u00e9sultat","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"Le fichier %filename ne peut pas \u00eatre envoy\u00e9. Seuls les documents de type %extensions sont accept\u00e9s.\r\n","__CURRENCY_SYMBOL":"\u20ac"},"complet":{"__UNAVAILABLE_OFFER":"Adresse non \u00e9ligible"}} };;
(function ($) {
